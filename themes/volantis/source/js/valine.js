...
!(function (e, t) {
    ...
    return (function (e) {
        ...
        function (e, t, n) {
            ...
            var c = n(47)();
            var u = Object.getPrototypeOf || function (e) {
                    return e.__proto__;
                }
            ;var d = i ? u(i) : void 0;
            var p = a ? u(a) : void 0;
            var f = a ? a() : void 0;
            var h = typeof Uint8Array == 'undefined' ? void 0 : u(Uint8Array);
            var v = {
                '%Array%': Array,
            ...
            var g = n(4);
            var m = g.call(Function.call, String.prototype.replace);
            var y = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g;
            var b = /\\(\\)?/g;
            var w = function (e) {
                var t = [];
        ...
        function (e, t, n) {
            ...
            function c(e, t, n, r) {
                ...
                t === 'href' || t === 'src') {
                    ...
                    if (n.substr(0, 7) !== 'http://' && n.substr(0, 8) !== 'https://' && n.substr(0, 7) !== 'mailto:' && n.substr(0, 4) !== 'tel:' && n[0] !== '#' && n[0] !== '/') {
                        return '';
                    }
...
*/
        ...
        function (e, t, n) {
            ...
            var i = function (e, t, n, r) {
                ...
                if (e === 'img' && ['src', 'class'].indexOf(t) > -1) {
        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                var t = this;
                if (typeof t != 'function' || o.call(t) !== '[object Function]') {
                            ...
                            a.prototype.tok = function () {
                                switch (this.token.type) {
                                    ...
                                    case 'blockquote_start':
                                        for (i = ''; this.next().type !== 'blockquote_end';) {
                                            i += this.tok();
                                        }
                                        return this.renderer.blockquote(i);
                                    case 'list_start':
                                        i = '';
                                        for (var a = this.token.ordered, s = this.token.start; this.next().type !== 'list_end';) {
                                            i += this.tok();
                                        }
                                        return this.renderer.list(i, a, s);
                                    case 'list_item_start':
                                        for (i = '',
                                             this.token.task && (i += this.renderer.checkbox(this.token.checked)); this.next().type !== 'list_item_end';) {
                                            i += this.token.type === 'text' ? this.parseText() : this.tok();
                                        }
                                        return this.renderer.listitem(i);
                                    case 'loose_item_start':
                                        for (i = ''; this.next().type !== 'list_item_end';) {
                                            i += this.tok();
                                        }
                                        return this.renderer.listitem(i);
                                    case 'html':
            ...
            if (!Object.keys) {
                ...
                r = function (e) {
                    ...
                    if (r && e.length > 0) {
                        ...
                        for (var g in e) {
                            p && g === 'prototype' || !o.call(e, g) || d.push(String(g));
                        }
                    }
                    if (l) {
                        for (var m = h(e), y = 0; y < u.length; ++y) {
                            m && u[y] === 'constructor' || !o.call(e, u[y]) || d.push(u[y]);
                        }
                    }
                    return d;
                };
